...
const AppBar = ({
  ...
  return (
    <div //type에 따라서 폰트 색상 inherit 할 수 있도록 parent 요소에서 폰트 색상 지정
      className={`fixed top-0 flex h-11 w-screen items-center border-b px-5 py-2.5 ${type === 'white' ? 'border-b-gray-100 bg-white text-black' : 'text-white [background:var(--Green-gradient,linear-gradient(0deg,rgba(0,0,0,0.10)_0%,rgba(0,0,0,0.10)_100%),linear-gradient(90deg,#5AE587_0%,#16BBC5_100%))]'}`}
    >
