...
const SvgChatSolid = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 24 24" {...props}>
    <path
      fill="#000"
      fillRule="evenodd"
      d="M4.794 3.25a2.574 2.574 0 0 0-2.573 2.574v9.264a2.574 2.574 0 0 0 2.573 2.574h11.683l4.502 3.002a.515.515 0 0 0 .8-.429V5.824a2.574 2.574 0 0 0-2.573-2.574z"
      clipRule="evenodd"
    />
    <path
      fill="#fff"
