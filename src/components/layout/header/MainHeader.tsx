  ...
  return (
    <header className='flex sticky top-0 w-full h-fit justify-between px-4 py-3 bg-white'>
      ...
      <span className='flex gap-3 items-center'>
        ...
        <SearchPerson className='w-6 h-6 text-neutral-600 cursor-pointer' />
        <Headphones className='w-6 h-6 text-neutral-600 cursor-pointer' />
        <Settings className='w-6 h-6 text-neutral-600 cursor-pointer' />
      </span>
    </header>
  );
};
